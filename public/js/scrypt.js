...
// console.log("first ans is : "+ ans);
 localStorage.setItem("userData", JSON.stringify([{"init":"Ayush","userScore":10,"bold":"","para":"","suggestion":"",
...
var questions = [
    ...
    {
        title: "Are you inconsistent in your daily activities?",
    ...
    if(finalScore>=10 && finalScore<=16){
     ...
     //   console.log("strong is : "+ first);
       ...
       */
        ...
        suggestion="To improve this situation you can follow these tips: -";
        suggestion_1="1. Do regular physical exercise";
        suggestion_2="2. Help other people";
        suggestion_3="3. Involve in pleasant activities";
        suggestion_4="4. eat right food";
    }
    var userData = {
        inits: a,
        userScore: b,
